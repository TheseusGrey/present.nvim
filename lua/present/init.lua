...
M.test_presentation = function(opts)
  opts = opts or {}
  ...
  presentation.floats.footer = s.create_floating_window(windows.footer)
  ...
  local set_slide_content = function(id)
    ...
    vim.api.nvim_buf_set_lines(presentation.floats.footer.buf, 0, -1, false, { footer })
  end
...
M.start_presentation = function(opts)
  ...
  local windows = styles.create_window_configurations(options.styles)
  presentation.floats.background = s.create_floating_window(windows.background)
  presentation.floats.header = s.create_floating_window(windows.header)
  presentation.floats.footer = s.create_floating_window(windows.footer)
  presentation.floats.body = s.create_floating_window(windows.body, true)
  ...
  local set_slide_content = function(idx)
    ...
    local slide = presentation.parsed.slides[idx]

    local padding = string.rep(" ", (width - #slide.title) / 2)
    local title = padding .. slide.title
    vim.api.nvim_buf_set_lines(presentation.floats.header.buf, 0, -1, false, { title })
    vim.api.nvim_buf_set_lines(presentation.floats.body.buf, 0, -1, false, slide.body)
